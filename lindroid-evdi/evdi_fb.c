                             ...
                             u32 *out_pitch, size_t *out_size)
{
    ...
    pitch = mode_cmd->pitches[0] ? mode_cmd->pitches[0] : cpp * mode_cmd->width;
                                                  ...
                                                  const struct drm_mode_fb_cmd2 *mode_cmd)
{
    size_t size;
    u32 pitch;
    if (evdi_fb_calc_size(mode_cmd, &pitch, &size))
        return NULL;
                             ...
                             const struct drm_mode_fb_cmd2 *mode_cmd)
{
    ...
    fb->pitches[0] = mode_cmd->pitches[0] ? mode_cmd->pitches[0] : evdi_fb_cpp(mode_cmd->pixel_format) * mode_cmd->width;
