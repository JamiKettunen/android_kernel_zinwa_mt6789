...
#include "imx111_mipi_raw.h"

/****************************Modify following Strings for debug****************************/
#define PFX "imx111_camera_sensor"

#define LOG_1 LOG_INF("IMX111,MIPI 4LANE\n")
...
/****************************   Modify end    *******************************************/
#define LOG_INF(format, args...)	pr_debug(PFX "[%s] " format, __FUNCTION__, ##args) // pr_debug
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX111_SENSOR_ID,

	.checksum_value = 0x467afd3a,
  ...
  //pSensorInfo->SensorMIPILaneNumber = SENSOR_MIPI_2_LANE;	
	.mipi_lane_num = SENSOR_MIPI_2_LANE, //SENSOR_MIPI_4_LANE,
...
{ 
	{ 3280, 2464,	 0,	0, 3280, 2464, 3280,  2464, 0000, 0000, 3280, 2464,	  0,	0, 3280,  2464}, // Preview
	...
	{ 3280, 2464,	 0,	0, 3280, 2464, 3280,  2464, 0000, 0000, 3280, 2464,	  0,	0, 3280,  2464}, //hight speed video
	{ 3280, 2464,	 0,	0, 3280, 2464, 3280,  2464, 0000, 0000, 3280, 2464,	  0,	0, 3280,  2464}, // slim video
	{ 3280, 2464,	 0,	0, 3280, 2464, 3280,  2464, 0000, 0000, 3280, 2464,	  0,	0, 3280,  2464}, // Custom1
	{ 3280, 2464,	 0,	0, 3280, 2464, 3280,  2464, 0000, 0000, 3280, 2464,	  0,	0, 3280,  2464}, // Custom2
	{ 3280, 2464,	 0,	0, 3280, 2464, 3280,  2464, 0000, 0000, 3280, 2464,	  0,	0, 3280,  2464}, // Custom3
	{ 3280, 2464,	 0,	0, 3280, 2464, 3280,  2464, 0000, 0000, 3280, 2464,	  0,	0, 3280,  2464}, // Custom4
	{ 3280, 2464,	 0,	0, 3280, 2464, 3280,  2464, 0000, 0000, 3280, 2464,	  0,	0, 3280,  2464}, // Custom5
 };
...
{
	 //(IMX111MIPI_read_cmos_sensor(0x0000)<<8) | IMX111MIPI_read_cmos_sensor(0x0001)
...
#if 1 //mars 
	write_cmos_sensor(0x0101, 0x00);//03
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
    ...
    spin_unlock(&imgsensor_drv_lock);
	LOG_INF("[IMX111MIPI] exit IMX111MIPISetTestPatternMode function \n");
    return ERROR_NONE;
}
		...
		do {
            *sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				LOG_INF("IMX111,MIPI 4LANE i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
				return ERROR_NONE;
			}
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			LOG_INF("IMX111,MIPI 4LANE Read sensor id fail, write id:0x%x id: 0x%x\n", imgsensor.i2c_write_id,sensor_id);
			retry--;
		} while(retry > 0);
		i++;
		if (sensor_id == imgsensor_info.sensor_id)
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	imgsensor.autoflicker_en = KAL_FALSE;
	spin_unlock(&imgsensor_drv_lock);
	preview_setting(); //normal_video_setting(imgsensor.current_fps); //mars
	set_mirror_flip(imgsensor.mirror);
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	imgsensor.autoflicker_en = KAL_FALSE;
	spin_unlock(&imgsensor_drv_lock);
	preview_setting(); //hs_video_setting(); //mars
	set_mirror_flip(imgsensor.mirror);
	return ERROR_NONE;
}	/*	hs_video   */
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	imgsensor.autoflicker_en = KAL_FALSE;
	spin_unlock(&imgsensor_drv_lock);
	preview_setting(); //slim_video_setting(); //mars
    return ERROR_NONE;
}   /*  slim_video   */
