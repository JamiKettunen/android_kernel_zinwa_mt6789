...
static struct imgsensor_info_struct imgsensor_info = {
    ...
    .sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gr,//SENSOR_OUTPUT_FORMAT_RAW_R,//SENSOR_OUTPUT_FORMAT_RAW_B,//SENSOR_OUTPUT_FORMAT_RAW_Gr
    .mclk = 24,
...
static struct imgsensor_struct imgsensor = {
    ...
    .ihdr_mode = 0,
    .hdr_mode = 0,
    .i2c_write_id = 0x5A,//0x20,
    .current_ae_effective_frame = 1,
};

/* Sensor output window information */
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
    { 4080, 3060,    0,    0, 4080, 3060, 4080, 3060,  0,   0, 4080, 3060,    0,    0, 4080, 3060}, /* preview sync with capture */
    { 4080, 3060,    0,    0, 4080, 3060, 4080, 3060,  0,   0, 4080, 3060,    0,    0, 4080, 3060}, /* capture */
    { 4080, 3060,    0,    0, 4080, 3060, 4080, 3060,  0,   0, 4080, 3060,    0,    0, 4080, 3060}, /* normal video sync with capture */
    { 4080, 3060,    0,    0, 4080, 3060, 4080, 3060,  0,   0, 4080, 3060,    0,    0, 4080, 3060}, /* high  speed video */
    { 4080, 3060,    0,    0, 4080, 3060, 4080, 3060,  0,   0, 4080, 3060,    0,    0, 4080, 3060}, /* slim video */
    { 4080, 3060,    0,    0, 4080, 3060, 4080, 3060,  0,   0, 4080, 3060,    0,    0, 4080, 3060}, /* custom1 */
    { 4080, 3060,    0,    0, 4080, 3060, 4080, 3060,  0,   0, 4080, 3060,    0,    0, 4080, 3060}, /* custom2 */
}; /*cpy from preview*/
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = ((read_cmos_sensor_16_8(0x0000) << 8) | read_cmos_sensor_16_8(0x0001));
            printk("read out sensor id 0x%x S5KJN1_SENSOR_ID =0x%x ,\n", *sensor_id,S5KJN1_SENSOR_ID);
	//	if (*sensor_id == 0x38E1)
		//	{
			//	*sensor_id = 0xF8D1;
		//	}
...
#ifdef PDAF_TEST
    sensor_info->PDAF_Support = 0;//2;  // 0 NO PDAF, 1 raw,  2 vc
#else
