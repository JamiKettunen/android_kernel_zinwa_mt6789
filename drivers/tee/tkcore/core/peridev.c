...
static void copy_clkmgr_handle(struct clkmgr_handle *to,
		struct clkmgr_handle *from)
{
	to->e = from->e;
	to->d = from->d;
	to->p0 = from->p0;
...
int __attribute__((weak)) plat_register_spi_clk(void)
{
	return 0;
}

int tee_peridev_init(void)
{
	return plat_register_spi_clk();
}

void tee_peridev_exit(void)
{
