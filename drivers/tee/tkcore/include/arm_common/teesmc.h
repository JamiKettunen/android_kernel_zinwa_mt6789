...
#define TEESMC_ATTR_ENABLE_NAMED_SHM	0x0008000U
#define TEESMC_ATTR_SHM_NAME_MASK	0x3FFU
#define TEESMC_ATTR_SHM_NAME_SHIFT	21
#define TEESMC_ATTR_SHM_NAME(id)	\
	(((id) & TEESMC_ATTR_SHM_NAME_MASK) << TEESMC_ATTR_SHM_NAME_SHIFT)
#define TEESMC_ATTR_SHM_NAME_GET(flags)	\
	(((flags) >> TEESMC_ATTR_SHM_NAME_SHIFT) & TEESMC_ATTR_SHM_NAME_MASK)
...
#define TEESMC64_CALL_GET_OS_UUID \
...
#define TEESMC64_CALL_GET_OS_REVISION \
	TEESMC_CALL_VAL(TEESMC_64, TEESMC_FAST_CALL, TEESMC_OWNER_TRUSTED_OS, \
			TEESMC_FUNCID_GET_OS_REVISION)
...
#define TEESMC64_FASTCALL_GET_SHM_CONFIG \
	TEESMC_CALL_VAL(TEESMC_64, TEESMC_FAST_CALL, TEESMC_OWNER_TRUSTED_OS, \
			TEESMC_FUNCID_GET_SHM_CONFIG)
 ...
 *
 * Call register usage:
 * r0	SMC Function ID, TEESMC32_FASTCALL_GET_LOGM_CONFIG
 * r1-6	Not used
 * r7	Hypervisor Client ID register
 *
 * Have config return register usage:
 ...
 * r4-7	Preserved
 */
#define TEESMC_FUNCID_GET_LOGM_CONFIG	0x5702
#define TEESMC32_FASTCALL_GET_LOGM_CONFIG \
	TEESMC_CALL_VAL(TEESMC_32, TEESMC_FAST_CALL, TEESMC_OWNER_TRUSTED_OS, \
			TEESMC_FUNCID_GET_LOGM_CONFIG)
#define TEESMC64_FASTCALL_GET_LOGM_CONFIG \
	TEESMC_CALL_VAL(TEESMC_64, TEESMC_FAST_CALL, TEESMC_OWNER_TRUSTED_OS, \
			TEESMC_FUNCID_GET_LOGM_CONFIG)

#define TKCORE_FUNCID_TRACE_CONFIG		0x5703
#define TEESMC32_TKCORE_FASTCALL_TRACE_CONFIG \
	TEESMC_CALL_VAL(TEESMC_32, TEESMC_FAST_CALL, TEESMC_OWNER_TRUSTED_OS, \
			TKCORE_FUNCID_TRACE_CONFIG)
#define TEESMC64_TKCORE_FASTCALL_TRACE_CONFIG \
	TEESMC_CALL_VAL(TEESMC_64, TEESMC_FAST_CALL, TEESMC_OWNER_TRUSTED_OS, \
			TKCORE_FUNCID_TRACE_CONFIG)
...
#define TEESMC_TKCORE_FUNCID_REMOVE_SHM		0x5706
#define TEESMC32_TKCORE_FASTCALL_REMOVE_SHM \
	TEESMC_CALL_VAL(TEESMC_32, TEESMC_FAST_CALL, TEESMC_OWNER_TRUSTED_OS, \
		TEESMC_TKCORE_FUNCID_REMOVE_SHM)
#define TEESMC64_TKCORE_FASTCALL_REMOVE_SHM \
	TEESMC_CALL_VAL(TEESMC_64, TEESMC_FAST_CALL, TEESMC_OWNER_TRUSTED_OS, \
		TEESMC_TKCORE_FUNCID_REMOVE_SHM)

#define TEESMC_FUNCID_CALL_WITH_ARG_WITH_RPC_SHM	0x5707
#define TEESMC32_CALL_WITH_ARG_WITH_RPC_SHM \
	TEESMC_CALL_VAL(TEESMC_32, TEESMC_STD_CALL, TEESMC_OWNER_TRUSTED_OS, \
	TEESMC_FUNCID_CALL_WITH_ARG_WITH_RPC_SHM)
#define TEESMC64_CALL_WITH_ARG_WITH_RPC_SHM \
	TEESMC_CALL_VAL(TEESMC_64, TEESMC_STD_CALL, TEESMC_OWNER_TRUSTED_OS, \
	TEESMC_FUNCID_CALL_WITH_ARG_WITH_RPC_SHM)
 ...
 *
 * "Call" register usage:
 * r0/x0	This value, TEESMC_RETURN_RPC_ALLOC_PAYLOAD
 * r1/x1	Size in bytes of required payload memory
 * r2/x2	Not used
 * r3-7/x3-7	Resume information, must be preserved
 *
 ...
 * r3-7/x3-7	Preserved
 */
#define TEESMC_TKCORE_RPC_FUNC_ALLOC_PAYLOAD	0x5700
#define TEESMC_RETURN_TKCORE_RPC_ALLOC_PAYLOAD	\
		TEESMC_RPC_VAL(TEESMC_TKCORE_RPC_FUNC_ALLOC_PAYLOAD)

/*
 * Free memory previously allocated by TEESMC_RETURN_RPC_ALLOC_PAYLOAD
 *
 * "Call" register usage:
 * r0/x0	This value, TEESMC_RETURN_RPC_FREE_PAYLOAD
 ...
 * r2-7/x2-7	Preserved
 */
#define TEESMC_TKCORE_RPC_FUNC_FREE_PAYLOAD		0x5701
#define TEESMC_RETURN_TKCORE_RPC_FREE_PAYLOAD	\
		TEESMC_RPC_VAL(TEESMC_TKCORE_RPC_FUNC_FREE_PAYLOAD)

#define TEESMC_TKCORE_RPC_BIND_CPU			0x5702
#define TEESMC_RETURN_TKCORE_RPC_BIND_CPU	\
		TEESMC_RPC_VAL(TEESMC_TKCORE_RPC_BIND_CPU)

#define TEESMC_TKCORE_RPC_FLUSH_TEE_LOG			0x5800
#define TEESMC_RETURN_TKCORE_RPC_FLUSH_TEE_LOG \
		TEESMC_RPC_VAL(TEESMC_TKCORE_RPC_FLUSH_TEE_LOG)
...
#define TEESMC_RETURN_EAFFINITY		0x6
#define TEESMC_RETURN_NOTAVAIL	0x5700
